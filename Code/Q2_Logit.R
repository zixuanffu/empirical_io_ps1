rm(list = ls())
pacman::p_load(data.table, fixest, xtable)
...
var_iv <- c("const_rival", "const_ownothers", "dpm_rival", "dpm_ownothers", "hp2wt_rival", "hp2wt_ownothers", "size_rival", "size_ownothers", "air_rival", "air_ownothers")
