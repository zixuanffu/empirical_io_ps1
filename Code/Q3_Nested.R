...
# estimation: iv
var_iv <- c("const_rival", "const_ownothers", "dpm_rival", "dpm_ownothers", "hp2wt_rival", "hp2wt_ownothers", "air_rival", "air_ownothers", "const_rival_g", "hp2wt_rival_g", "dpm_rival_g", "air_rival_g")
...
etable(reg_ols1, reg_ols2, reg_iv1, reg_iv2,
    ...
    fitstat = ~ n + ar2 + ivf1 + ivf1.p + sargan + sargan.p,
